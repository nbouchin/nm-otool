...
/*   Updated: 2018/10/18 16:28:01 by nbouchin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(int argc, char **argv)
{
	...
	while (++nb_file < argc)
	{
		...
		if (mach_header_64 == MAP_FAILED)
			return (0);
		if (mach_header_64->magic != MH_MAGIC && mach_header_64->magic != MH_CIGAM && mach_header_64->magic != MH_MAGIC_64 && mach_header_64->magic != MH_CIGAM_64 && mach_header_64->magic != FAT_MAGIC && mach_header_64->magic != FAT_CIGAM && mach_header_64->magic != FAT_MAGIC_64 && mach_header_64->magic != FAT_CIGAM_64)
