...
/*   Updated: 2018/10/19 13:44:17 by nbouchin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		process_header(t_mach_header_64 *mach_header_64, uint32_t magic)
{
	...
	if (mach_header_64->magic != MH_MAGIC)//is_64bits(magic))
	{
		pass = 1;
	...
	else if (mach_header_64->magic == MH_MAGIC && pass == 0)//is_32bits(magic) && pass == 0)
	{
